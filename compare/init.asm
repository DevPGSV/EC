...
start:
        ...
        STR R1, [R5]    // Store in the address pointed by R5 the value of R1 (R4 <- =X; R1 <- [R4]; [R5] <- R1;)
        B FIN           // Go to "FIN"
else:   STR R2, [R5]    // Store in the address pointed by R5 the value of R2 (R3 <- =Y; R2 <- [R3]; [R5] <- R2;)
